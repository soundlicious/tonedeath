 ...
 */
public class InitFinalDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(InitFinalDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(InitFinalDetailFragment.ARG_ITEM_ID));
