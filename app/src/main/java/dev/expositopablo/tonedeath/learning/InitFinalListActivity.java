 ...
 */
public class InitFinalListActivity extends AppCompatActivity {
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(InitFinalDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(InitFinalDetailFragment.ARG_ITEM_ID, item.id);
